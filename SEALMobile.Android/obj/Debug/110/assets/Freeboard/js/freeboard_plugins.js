...
var freeboard = (function()
{
	...
	// PUBLIC FUNCTIONS
	// Load saved dashboard automatically.
	return {
		initialize          : function(allowEdit, finishedCallback)
		{
			...
			// NOTE: Temp json freeboard config for 19th Oct presentation.
			freeboardConfig =	{
				"version": 1,
				"allow_edit": true,
				"plugins": [],
						...
						"widgets": [
							{
								...
								"settings": {
									"title": "",
									"value": "parseFloat(datasources[\"selfhosted\"][\"undefined\"]).toFixed(2)",
									"units": "%",
									"min_value": 0,
									"max_value": 100
								}
						...
						"widgets": [
							{
								...
								"settings": {
									"size": "regular",
									"value": "datasources[\"selfhosted\"][\"undefined\"]",
									"animate": true
								}
							}
						]
				...
				"datasources": [
					{
						...
						"settings": {
							"topic": "@msg/decrypted",
							"server": "mqtt.ntscloud.cc",
							"port": 9002,
							"use_encryption": true,
							"client_id": "testtopic-12345",
							"api_key": "cyblion",
